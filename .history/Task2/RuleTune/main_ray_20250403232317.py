...
import sys
sys.path.append("c:/Users/spran/OneDrive - Indian Institute of Technology (BHU), Varanasi/Desktop/BTP/TueSan/Task2/Seq2Seq-Decoding")
...
def load_task2_test_data(file_path, translit=False):
    """
    Load Task 2 test data from a file.

    Args:
        file_path (Path): Path to the test data file.
        translit (bool): Whether to transliterate the input.
    ...
    with open(file_path, "r", encoding="utf-8") as f:
        for line in f:
            ...
            if line:
                if translit:
                    # Perform transliteration if required
                    line = to_uni(line)
